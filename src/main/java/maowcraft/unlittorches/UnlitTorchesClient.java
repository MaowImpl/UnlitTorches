...
public class UnlitTorchesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(UnlitTorchesContent.TRAPPED_UNLIT_WALL_TORCH, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(UnlitTorchesContent.UNLIGHTABLE_UNLIT_WALL_TORCH, RenderLayer.getCutout());
    }
}
